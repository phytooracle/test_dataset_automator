...
ssh filexfer "cd /xdisk/dukepauli/${USER}/;iget -KFT ${SCAN_PATH}"
echo "Scan ${SCAN_FILE_NAME} download complete. (1/3)"

tar -xzvf ${SCAN_FILE_NAME}
echo "File extraction done. (2/3)"

# --TESTED TILL THIS POINT--
echo "Selecting files for the test dataset. (3/3)"
